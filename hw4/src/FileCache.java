...
public class FileCache {
    ...
    public FileCache(String fileName, String clientIP) {
        System.out.println("Creating new FileCache with name: " + fileName);
        this.name = fileName;
        this.Readers = new Vector<String>();
        this.Readers.add(clientIP);
        this.owner = clientIP;
    ...
    public void write(String clientIP, byte[] newData) {
        this.owner = clientIP;
        this.data = newData;
